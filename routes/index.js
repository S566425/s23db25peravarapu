...
res.render('index', { title: 'Organisation', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'Organisation App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Organisation App Login', user : req.user });
  });
